...
1 초	256 MB	74111	25294	15861	32.509%
...
tmt_farm = [list(map(int,input().split())) for _ in range (n)]
vertical=[1,-1,0,0]
horizon=[0,0,1,-1]
...
while queue:
    ...
    for k in range(4):
        dx=a+vertical[k]
        dy=b+horizon[k]
        if n>dx>=0 and m>dy>=0 and tmt_farm[dx][dy]==0:
            queue.append((dx,dy))
            tmt_farm[dx][dy]=tmt_farm[a][b]+1
